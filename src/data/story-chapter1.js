...
export const chapter1Graph = {
    ...
    chapter1_intro_choice_1: {//第一个选项节点
        ...
        choices: [
          {
            id: 'chapter1_intro_choice_1_a',
            label: '老老实实做委托',        // 选项1文案
            nextId: 'chapter1_meet_1',             // 正常推进到后面的剧情节点
            failOnChoose: false,
          },
          {
            id: 'chapter1_intro_choice_1_b',
      ...
      chapter1_intro_fail_1: {//失败节点
        id: 'chapter1_intro_fail_1',
    ...
    chapter1_meet_17: {
        ...
        speakerName: '派蒙',
        text: '好耶！旅行者，可以白蹭他的饭！',
        nextId: 'chapter1_meet_choice_1', // 预留后续剧情ID，可根据需要修改
    },
    chapter1_meet_choice_1: {//第二个选项节点
        id: 'chapter1_meet_choice_1',
        type: 'choice',
        speaker: 'narrator',        // 或 'paimon'，看你想谁说
        speakerName: '',            // 如果是旁白可以留空
        text: '接下来你会：',       // 对话框里的提示文字
        choices: [
          {
            id: 'chapter1_meet_choice_1_a',
            label: '接受达达利亚的邀请，有饭吃还有1600原石！',        // 选项1文案
            nextId: 'chapter1_meet_18',             // 正常推进到后面的剧情节点
            failOnChoose: false,
          ...
          {
            id: 'chapter1_meet_choice_1_b',
            label: '拒绝达达利亚的邀请，是愚人众的阴谋怎么办？',  // 选项2文案
            nextId: 'chapter1_meet_fail_1',                     // 直接跳到失败节点
            failOnChoose: true,                         // 标记为“这条路是失败”
      ...
      chapter1_meet_fail_1: {
        id: 'chapter1_meet_fail_1',
        type: 'dialogue',
        speaker: 'narrator',
        speakerName: '',
        text:
    ...
    chapter1_meet_19: {
        ...
        speakerName: '达达利亚',
        text: '没问题。',
        nextId: 'chapter1_lunch_1', // 预留后续剧情ID，可根据需要修改
    },
    //午餐对话节点
      chapter1_lunch_1: {
        id: 'chapter1_lunch_1',
    ...
    chapter1_lunch_7: {
        ...
        nextId: 'chapter1_lunch_choice_1', // 预留后续剧情ID，可根据需要修改
    },
    // 新增切磋选项节点
    chapter1_lunch_choice_1: {
        id: 'chapter1_lunch_choice_1',
        type: 'choice',
        speaker: 'narrator',
        speakerName: '',
        text: '接下来你会：',
        choices: [
        {
            id: 'chapter1_lunch_choice_1_a',
            label: '接受切磋邀请，满足达达利亚的战斗欲',
            nextId: 'chapter1_lunch_8', // 正确选项，推进到后续剧情
            failOnChoose: false,
            affectionDelta: {
        ...
        {
            id: 'chapter1_lunch_choice_1_b',
            label: '拒绝切磋邀请，这个家伙怎么尽想着打架？',
            nextId: 'chapter1_lunch_fail_1', // 跳转到失败节点
            failOnChoose: true,
            affectionDelta: {
    ...
    // 新增切磋失败节点
    chapter1_lunch_fail_1: {
        id: 'chapter1_lunch_fail_1',
        type: 'dialogue',
        speaker: 'narrator',
        speakerName: '',
    ...
    chapter1_lunch_8: {
        ...
        speakerName: '你',
        text: '（白眼）我就知道。',
        nextId: 'chapter1_fight_1', // 预留后续切磋剧情ID
        affectionTip: {
    ...
    chapter1_fight_9: {
        ...
        nextId: 'chapter1_fight_10',
    },
    chapter1_fight_10: {
        id: 'chapter1_fight_10',
        type: 'narration',
        speaker: 'narration',
        speakerName: '',
        text: '你给了。达达利亚做了三碗极致一钓，每人一碗。你和派蒙看着面前那卖相不佳的菜满头黑线。',
        nextId: 'chapter1_fight_11', // 指向吃饭选项节点
    },
    
    chapter1_fight_11: {
        id: 'chapter1_fight_11',
        type: 'dialogue',
        speaker: 'paimon',
        speakerName: '派蒙',
        text: '呜哇，这是什么！',
        nextId: 'chapter1_fight_12', // 预留后续剧情ID
        affectionTip: {
        tartaglia: 3 // 接受吃饭后好感度+1（从2→3）
        }
    },
    chapter1_fight_12: {
        id: 'chapter1_fight_12',
        type: 'dialogue',
        speaker: 'tartaglia',
        speakerName: '达达利亚',
        text: '（眯眼笑）只是在原来的基础上加了一些海钓的战利品和老家特产而已。',
        nextId: 'chapter1_fight_13', // 预留后续剧情ID
    },
    chapter1_fight_13: {
        id: 'chapter1_fight_13',
        type: 'dialogue',
        speaker: 'paimon',
        speakerName: '派蒙',
        text: '呜，看起来就没胃口！旅行者你先吃！',
        nextId: 'chapter1_fight_choice_1', // 预留后续剧情ID
    },
    // 新增吃饭选项节点
    chapter1_fight_choice_1: {
        id: 'chapter1_fight_choice_1',
        type: 'choice',
        speaker: 'narrator',
        speakerName: '',
        text: '接下来你会：',
        choices: [
        {
            id: 'chapter1_fight_choice_1_a',
            label: '吃，这是达达利亚的心意！',
            nextId: 'chapter1_fight_14', // 正确选项，推进后续剧情
            failOnChoose: false,
            affectionDelta: {
        ...
        {
            id: 'chapter1_fight_choice_1_b',
            label: '不吃，这看起来太怪了！',
            nextId: 'chapter1_starnight_1', // 直接跳转到星夜节点
            failOnChoose: true,
            affectionDelta: {
    ...
    // 接续 fight_13 的后续节点
chapter1_fight_14: {
    id: 'chapter1_fight_14',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '（鼓起勇气）这可是达达利亚的心意啊，我吃！（努力吃下去）嗯，没想到味道居然相当不错呢！和原本的嘟嘟莲海鲜羹有着不同的风味！',
    nextId: 'chapter1_fight_15',
  },
  chapter1_fight_15: {
    id: 'chapter1_fight_15',
    type: 'dialogue',
    speaker: 'paimon',
    speakerName: '派蒙',
    text: '真的？（吃了一口）好吃！',
    nextId: 'chapter1_starnight_1', // 按要求指向 starnight_1
  },
  
  // 星夜剧情节点
  chapter1_starnight_1: {
    id: 'chapter1_starnight_1',
    type: 'dialogue',
    speaker: 'paimon',
    speakerName: '派蒙',
    text: '没想到你的厨艺真不错！',
    nextId: 'chapter1_starnight_2',
  },
  chapter1_starnight_2: {
    id: 'chapter1_starnight_2',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '我可是在生活的方方面面也追求变强的人。做饭是，钓鱼也是。',
    nextId: 'chapter1_starnight_3',
  },
  chapter1_starnight_3: {
    id: 'chapter1_starnight_3',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '钓鱼？钓鱼协会的人说，鱼线稳定器在至冬推广尤其顺利，据说是受到了某位执行官的喜爱，该不会就是你吧？',
    nextId: 'chapter1_starnight_4',
  },
  chapter1_starnight_4: {
    id: 'chapter1_starnight_4',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '哈哈哈，没错。说起来，我还是从老爹那喜欢上的钓鱼呢。小时候，老爹经常带我去冰湖上钓鱼，虽然等鱼上钩的时间很漫长，但他会给我讲英雄阿贾克斯的冒险故事。在那些故事的陪伴下，钓鱼似乎也不那么无聊了呢。',
    nextId: 'chapter1_starnight_5',
  },
  chapter1_starnight_5: {
    id: 'chapter1_starnight_5',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '阿贾克斯的故事？我好像听说过一些。',
    nextId: 'chapter1_starnight_6',
  },
  chapter1_starnight_6: {
    id: 'chapter1_starnight_6',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '阿贾克斯可是我们那很有名的神话英雄。也是因为崇拜他，我的老爹也给我起了个阿贾克斯的名字。',
    nextId: 'chapter1_starnight_7',
  },
  chapter1_starnight_7: {
    id: 'chapter1_starnight_7',
    type: 'dialogue',
    speaker: 'paimon',
    speakerName: '派蒙',
    text: '原来你的本名叫阿贾克斯？那我们以后可不可以直接这么称呼你呀？',
    nextId: 'chapter1_starnight_8',
  },
  chapter1_starnight_8: {
    id: 'chapter1_starnight_8',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '当然可以，无论是代号「公子」，还是女皇陛下赐予我的名字达达利亚，抑或是我的本名阿贾克斯，都行，因为我们都是老熟人了嘛。',
    nextId: 'chapter1_starnight_9',
  },
  chapter1_starnight_9: {
    id: 'chapter1_starnight_9',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '阿贾……（脸红）算了我还是不习惯直接喊你本名呢。说不定等我旅行到至冬，到你家去做客，才会在你家人面前这么喊吧。你大概不想让家里人和愚人众有过多关联。',
    nextId: 'chapter1_starnight_10',
  },
  chapter1_starnight_10: {
    id: 'chapter1_starnight_10',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '我确实不希望他们接触到这些至冬国的阴暗面。不够光彩的事情，就由我来做好了。身为愚人众的执行官，这也是本职工作。',
    nextId: 'chapter1_starnight_11',
  },
  chapter1_starnight_11: {
    id: 'chapter1_starnight_11',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '我曾读过一首至冬的诗歌，内容就是讲愚人众的。在里面作者把执行官比作「白夜极星」，挺浪漫的比喻。让我想象一下，你在愚人众里是极星一样的存在，嗯……还挺帅？',
    nextId: 'chapter1_starnight_12',
  },
  chapter1_starnight_12: {
    id: 'chapter1_starnight_12',
    type: 'dialogue',
    speaker: 'tartaglia',
    speakerName: '达达利亚',
    text: '哈哈，可惜这里是枫丹，看不到极星是什么样子。如果是在至冬的晴朗的晚上，就能看见了。而且还有其他地方也看不到的极光呢。虽然至冬气候不怎么样，但是极光是真的美。等你来了至冬，我一定带你去看，我的老家就可以看到。',
    nextId: 'chapter1_starnight_13',
  },
  chapter1_starnight_13: {
    id: 'chapter1_starnight_13',
    type: 'dialogue',
    speaker: 'traveler',
    speakerName: '你',
    text: '好，说话算话！',
